...
(
	...
	location	 /*地區*/	   NVARCHAR(10)  NOT NULL DEFAULT '台北市'
);   
...
(	teamId		/*隊伍編號*/  INT NOT NULL FOREIGN KEY REFERENCES Team(teamId),
	...
	checked     /*已讀*/      INT DEFAULT 0 -- (0)未讀 (1) 已讀 
...
(
	...
	memberId        /*留言人*/      UNIQUEIDENTIFIER NOT NULL,
	memberName      /*姓名*/        nvarchar(10) not null,
	memberUrl       /*圖片檔名*/    nvarchar(20),
	memberFBId      /*fbID*/        VARCHAR(20),
...
(
likeId       /*LIKE編號*/    INT          identity Primary Key, 
chatId       /*聊天編號*/    INT FOREIGN KEY REFERENCES ClubChat(chatId),
memberName   /*姓名*/        nvarchar(10) not null,
memberId     /*留言人*/      UNIQUEIDENTIFIER NOT NULL
)
...
(
	...
	fouls           /*犯規*/                INT,
	score			/*成員得分*/		    INT      ,
	FOREIGN KEY (clubMemberId) REFERENCES dbo.Member(memberId),
...
(
	...
	--filename		    /*隊徽名*/			        varchar(20)	    NOT NULL,
	  ...
	  start5URL          /*先發照片 on server*/       varchar(50)	    NOT NULL,
);
